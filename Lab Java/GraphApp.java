...
/* traverse to the right to check whether the edge weight is smaller than min. If it is smaller and this adjVertex isn’t in minspt, update min, fromVertex, and toVertex */
...
/* Ex 3 The methods findMinSPT repeatedly calls addMinAdjVertex(minspt) when the vertexCount in minspt is still less than the vertexCount of Graph */
    ...
    GraphApp<T> findMinSPT() {
        ...
        //add your code here
        while(vertexCount!=minspt.vertexCount){
...
// -------------------- Ex.4 and 5--------------------------
    GraphApp<T> findShortestPath(T fromV, T toV) {
        ...
        searchVertex(fromV).distance = 0; //set distance at fromV =0
        ...
        while (dijkstra.searchVertex(toV)==null) {
            ...
            while (currentList != null) {
                ...
                { 
/* calculate cumulative distance (cumdist) at tempMember.      if the toVertex isn’t in the Dijkstra graph and cumdist less than min, update the min, fromVertex, and toVertex */
                
                  //add your code here
                	
                	cumdist = currentList.distance+tempMember.weight;
                	if(dijkstra.searchVertex(tempMember.adjVertex)== null && cumdist < min){
...
/*insert toVertex to Dijkstra graph and update distance and parent of the selected vertex */
            ...
            dijkstra.searchVertex(toVertex).distance = min;
            dijkstra.searchVertex(toVertex).parent = fromVertex;
